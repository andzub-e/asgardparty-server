...
func New(config *constants.Config) (*Validator, error) {
	...
	v.register(constants.GameRuleName, stringOneOfTheList(v.config.AvailableGames)).
		register(constants.IntegratorRuleName, stringOneOfTheList(v.config.AvailableIntegrators))
...
func (v *Validator) ValidateStruct(obj interface{}) error {
	...
	case reflect.Slice, reflect.Array:
		...
		return validateRet
	case reflect.Bool, reflect.Chan, reflect.Complex128, reflect.Complex64, reflect.Float32,
		reflect.Float64, reflect.Func, reflect.Int, reflect.Int16, reflect.Int32, reflect.Int64,
		reflect.Int8, reflect.Interface, reflect.Invalid, reflect.Map, reflect.String, reflect.Uint,
